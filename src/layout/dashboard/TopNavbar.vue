<template>
  <nav class="navbar navbar-expand-xl navbar-absolute" :class="{ 'bg-white': showMenu, 'navbar-transparent': !showMenu }">
          ...
          <ul class="navbar-nav" :class="$rtl.isRTL ? 'mr-auto' : 'ml-auto'">
            ...
            <modal :show.sync="searchModalVisible" class="modal-search" id="searchModal" :centered="false"
              ...
              <input slot="header" v-model="searchQuery" type="text" class="form-control" id="inlineFormInputGroup"
                placeholder="SEARCH">
            </modal> <base-dropdown tag="li" :menu-on-right="!$rtl.isRTL" title-tag="a" class="nav-item">
